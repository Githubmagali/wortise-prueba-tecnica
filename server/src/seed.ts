...
const SEED_USERS = [
  { name: "Magali", email: "magali@example.com", password: "password123" },
  { name: "Esteban", email: "esteban@example.com", password: "password123" },
];

const SEED_ARTICLES = [
  {
    authorEmail: "magali@example.com",
  ...
  {
    authorEmail: "esteban@example.com",
